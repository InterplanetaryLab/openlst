...
COMMANDS = [
    ...
    Command("set_led_forward", SET_LED_FORWARD, UInt8Argument("hwid"),  UInt8Argument("freq1")),
    Command("clear_led_forward", CLEAR_LED_FORWARD, UInt8Argument("hwid"), UInt8Argument("freq1")),
